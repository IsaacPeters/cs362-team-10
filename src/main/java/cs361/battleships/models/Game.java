...
public class Game {
    ...
    public boolean moveShip(int direction, boolean isVertical){
        int directionChoice = direction;

           boolean successful = playersBoard.moveShip(directionChoice, isVertical);
